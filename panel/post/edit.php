<?php 
    ...
    if(
            ...
            if($category !== false && $image_upload !== false)
        {
            ...
            $statement = $pdo->prepare($query);
            $statement->execute([$_POST['title'], $_POST['cat_id'], $_POST['body'], $image_saving, $_GET['post_id']]);
        }
                ...
                <section class="col-md-10 pt-3">
                    ...
                    <form action="<?= url('panel/post/edit.php?post_id=' . $_GET['post_id'])?>" method="post" enctype="multipart/form-data">
                        ...
                        <section class="form-group">
                            ...
                            <img src="<?= asset($post->image)?>" alt="" class="mt-2" width="100" height="100">
                        </section>
                        <section class="form-group">
                        ...
                        <section class="form-group">
                            ...
                            <textarea class="form-control" name="body" id="body" rows="5" value="<?= $category->body?>"><?= $post->body ?></textarea>
                        </section>
                        <section class="form-group">
